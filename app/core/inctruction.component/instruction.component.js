...
__decorate([
    core_1.HostBinding('@routeAnimationLeft'),
    __metadata("design:type", animations_service_1.AnimationsServices)
...
InstructionComponent = __decorate([
    core_1.Component({
        ...
        animations: [
            animations_service_1.AnimationsServices.animatonThreeStates('routeAnimationLeft', { opacity: 1, transform: 'translateX(0)' }, [{ opacity: 0, transform: 'translateX(-100%)' }, { opacity: 0, transform: 'translateX(-100%)' }], ['0.4s ease-in', '0.4s ease-out'])
        ]
    })
